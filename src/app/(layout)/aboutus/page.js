  ...
  return (
    <div className="mt-40">
      <div className="flex justify-evenly">
        <div data-aos="flip-right" className="shadow-md p-1 text-justify w-1/4 flex flex-col justify-center items-center">
        ...
        <div data-aos="flip-up" className="shadow-md p-4 text-justify w-1/4">
        ...
        <div data-aos="flip-left" className="shadow-md p-4 text-justify w-1/4">
          <p className="font-BYekan">
            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با
            استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در
            ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز،
      ...
      <div className="mt-9 mx-20 flex flex-col">
        <div data-aos="fade-up" className=" my-4 flex justify-evenly gap-9 items-center w-full text-justify p-9">
          <div data-aos="fade-left" className="flex flex-col w-2/3  ">
        ...
        <div  className="flex gap-9 p-9 my-9 mt-9 justify-center w-full font-BYekan text-justify">
          ...
          <div data-aos="fade-right" className="flex flex-col w-2/3">
