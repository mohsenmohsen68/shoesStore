      ...
      },
      {
        ...
        renderCell: (params) => (
          ...
          <BiShow className="text-red-500 text-2xl" onClick={()=>{
            ...
            setIsChecked(params.row.isChecked)
            handleOpen()
          }}/>
        </div>
        ),
    ...
    <div className='w-full h-full p-2 font-BYekan'>
      ...
      <Modal open={open} onClose={handleClose}>
                <Box sx={style} className='flex flex-col gap-y-2'>
                    ...
                    <div>
                        <input type="checkbox" id="checkBox" defaultChecked={isChecked} onChange={()=>setIsChecked(!isChecked)} className="ml-2" />
                        <label htmlFor="checkBox">مشاهده شد...</label>
                      </div>
                      <div>
                        <button
